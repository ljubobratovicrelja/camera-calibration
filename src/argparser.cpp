...
arg_parser& arg_parser::def_argument(const argument& arg) {
...
argument* arg_parser::try_fetch(const std::string& key) {
    ...
    auto search_advocate = [&key_s](const argument& arg) {
            return arg.long_key == key_s || arg.short_key == key_s;
        };
...
argument::argument(bool& flag, const std::string& long_key, const std::string& short_key, const std::string& description) {
    this->given = false;
    this->flag = &flag;
...
argument::argument(std::string& value, const std::string& long_key, const std::string& short_key,
...
argument::argument(int& value, const std::string& long_key, const std::string& short_key, const std::string& description) {
    this->given = false;
    this->integer = &value;
...
argument::argument(double& value, const std::string& long_key, const std::string& short_key, const std::string& description) {
    this->given = false;
    this->flt = &value;
